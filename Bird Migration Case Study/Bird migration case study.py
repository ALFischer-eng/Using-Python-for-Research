...
This code uses data from a gps bird-tracking study of three different 
seagulls. We will make several plots describing their migration speeds 
and patterns. 
PLEASE NOTE: The last plot of this code required the cartopy module
which can be found here: https://scitools.org.uk/cartopy/docs/latest/
"""


"""Import bird data from csv, may need to edit for your pwd"""
import pandas as pd
...
"""plotting using pandas, which will deal with NaNs for you"""
